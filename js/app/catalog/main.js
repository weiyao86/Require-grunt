        ...
        var main = {
                ...
                self.infoQueryOpts = {
                    callbacks: {
                        onVsnAndVinToCatalog: function (nodes) {
                            self.onGoToUsage(nodes, { isToGroup: true });
                        },
                        onGoToUsage: function (nodes, partNumber) {
                            self.onGoToUsage(nodes, { partNumber: partNumber });
                        }
                    }
                };
                    ...
                    ajax.invoke({
                        ...
                        success: function (root) {
                            if (root) {
                                ...
                                contentHtm = Mustache.render(self.userContentTemplate, { UserContent: data.UserContent });
            ...
            onGoToUsage: function (nodes, params) {
                ...
                if (hasHome.Home == "1") {
                    ...
                    var arr = [], href = window.location.href;
                    for (var key in ret) {
